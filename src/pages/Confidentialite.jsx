const SECTIONS = [
  { title: '1. Responsable du traitement', content: `NEXT BUILD SAS, 12 rue de la Tech, 75011 Paris.\nDélégué à la Protection des Données (DPO) : dpo@nextbuild.fr` },

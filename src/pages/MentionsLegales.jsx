const ARTICLES = [
  { title: '1. Éditeur du site', content: `NEXT BUILD SAS\nCapital social : 50 000 €\nSiège social : 12 rue de la Tech, 75011 Paris, France\nRCS Paris : 123 456 789\nN° TVA intracommunautaire : FR 12 123456789\nDirecteur de la publication : Thomas Dupont` },
  { title: '2. Hébergement', content: `Le site nextbuild.fr est hébergé par :\nAmazon Web Services EMEA SARL\n38 avenue John F. Kennedy, L-1855 Luxembourg\nwww.aws.amazon.com` },
  { title: '3. Propriété intellectuelle', content: `L'ensemble des contenus présents sur ce site (textes, images, logos, graphismes, icônes) est la propriété exclusive de NEXT BUILD SAS ou de ses partenaires. Toute reproduction, même partielle, est strictement interdite sans autorisation préalable écrite.` },
  { title: '4. Responsabilité', content: `NEXT BUILD SAS s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur ce site. Cependant, elle ne peut garantir l'exactitude, la précision ou l'exhaustivité des informations mises à disposition. NEXT BUILD SAS décline toute responsabilité pour tout dommage résultant d'une intrusion frauduleuse, d'une indisponibilité du service ou d'une utilisation non conforme.` },
  { title: '5. Données personnelles', content: `Les données collectées sur ce site font l'objet d'un traitement informatique conformément au RGPD. Pour en savoir plus, consultez notre Politique de confidentialité. Vous disposez d'un droit d'accès, de rectification et de suppression de vos données en contactant : dpo@nextbuild.fr` },
